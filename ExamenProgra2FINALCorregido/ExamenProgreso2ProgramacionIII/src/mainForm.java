...
public class mainForm extends JFrame {
    ...
    public mainForm() {
        ...
        mostrarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (comboBoxOrder.getSelectedIndex()== 0){
                    ...
                    for (int i=0;i<menuNew.getArregloInsercion().size();i++){
                        textAMostrar.append(menuNew.getArregloInsercion().get(i) + "\n");
                    }
        ...
        buscarButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (!textBuscarPlatoOrden.getText().isEmpty() && menuNew.searchBinary(menuNew.platosMenu,textBuscarPlatoOrden.getText()) !=null) {

                    Plato platoBuscar=menuNew.searchBinary(menuNew.platosMenu,textBuscarPlatoOrden.getText());
                    textAMostrar.setText(platoBuscar.toString());
                }else {
                    JOptionPane.showMessageDialog(null, "No existe ese plato o el campo esta vacio");
                }
            }
