...
public class mainForm extends JFrame {
    ...
    private JButton ordenarBurbujaInserccionButton;
    Plato platoNew;
    ...
    public mainForm() {
        ...
        ordenarBurbujaNombreButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                menuNew.Burbuja();
                textArea1.setText(" ");
                for (int i=0;i<menuNew.getArregloBurbuja().size();i++){
                    textArea1.append(menuNew.getArregloBurbuja().get(i) + "\n");
                }
            }
        });
    }
